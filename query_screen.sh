...
while IFS= read -r peer_id; do
    ...
    echo "$peer_id,$peer_id_base64,$difficulty,$difficulty_metric,$commit16_metric,$commit128_metric,$commit1024_metric,$commit65536_metric,$proof16_metric,$proof128_metric,$proof1024_metric,$proof65536_metric,$cores,$memory,$storage,$last_seen"
done < peerlist